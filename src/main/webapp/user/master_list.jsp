		...
		<div class="container filter">
			<div class="main-area">
				<form id="filter-form" action="search.jsp" method="GET">
					<div class="filter">
						<label for="category">상위 카테고리</label> <select id="category" onchange="handleCategoryChange()">
					...
					<div class="filter" id="sub-category-filter" style="display: none;">
						<label for="sub-category">하위 카테고리</label> <select id="sub-category">
							<option value="">선택</option>
						</select>
					</div>
					<div class="filter">
					...
					<div class="search-filters">
						...
						<div class="search-filter">
							<label for="rating-filter">별점순</label> <select id="rating-filter">
