	...
	<section class="main-section">
		<div class="container">
			<nav class="sidebar">
				...
				<ul>
					<li>
						<a href="profile_edit.jsp">회원정보 수정</a>
					</li>
					<li>
						<a href="reserve_list.jsp">예약 내역</a>
					</li>
					<li>
						<a href="review_list.jsp">후기 내역</a>
					</li>
					<li>
						<a href="message_list.jsp" class="active">문의 내역</a>
					</li>
				</ul>
			</nav>
			<div class="content">
				...
				<div class="chatlist">
					<div class="chatroom">
						...
						<div class="chatroom-info">
							<div class="chatroom-name">
								<span id="mastername"><strong>김현용</strong></span> 마스터님<span class="new-mark active">N</span>
							</div>
					...
					<div class="chatroom">
						...
						<div class="chatroom-info">
							<div class="chatroom-name">
								<span id="mastername"><strong>조예원</strong></span> 마스터님
							</div>
					...
					<div class="chatroom">
						...
						<div class="chatroom-info">
							<div class="chatroom-name">
								<span id="mastername"><strong>박서희</strong></span> 마스터님
							</div>
