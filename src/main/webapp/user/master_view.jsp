	...
	<section class="main-section">
		<div class="container">
			<div class="content master-view">
				<div class="new-edit-form">
					...
					<div class="new-master-section">
						...
						<div class="reserve-button-block">
							<a href="${pageContext.request.contextPath }/user/request.jsp" class="new-btn new-reserve" id="reserve-button">예약 신청</a>
				...
				<div class="new-career_section">
					<div class="new-career_sectiontitle">
						<svg width="35" height="35" fill="#121619" xmlns="http://www.w3.org/2000/svg" class="assets_asset__PJO1J" viewBox="0 0 48 48" name="workLight">
                            <g clip-path="url(#icon_work_light_svg__a)" fill-rule="evenodd" clip-rule="evenodd" fill="#121619">
                                <path d="M20.711 12.224a.21.21 0 0 0-.011.076V16h6.8v-3.7a.21.21 0 0 0-.015-.085.21.21 0 0 0-.085-.015h-6.6a.21.21 0 0 0-.085.015.057.057 0 0 0-.004.009ZM28.6 17.1h1.1v-4.8c0-1.308-.992-2.3-2.3-2.3h-6.6c-1.308 0-2.3.992-2.3 2.3v4.8a1.1 1.1 0 0 0 1.1 1.1h9v-1.1Z">
                                </path>
                                <path d="M14.7 18.2a2.485 2.485 0 0 0-2.5 2.5v12.8c0 1.392 1.107 2.5 2.5 2.5h18.8c1.392 0 2.5-1.108 2.5-2.5V20.7c0-1.392-1.108-2.5-2.5-2.5H14.7ZM10 20.7c0-2.607 2.092-4.7 4.7-4.7h18.8c2.608 0 4.7 2.093 4.7 4.7v12.8c0 2.608-2.093 4.7-4.7 4.7H14.7a4.685 4.685 0 0 1-4.7-4.7V20.7Z">
                                </path>
                                <path d="M37.1 25.2h-26V23h26v2.2Z"></path>
                                <path d="M23 29.1v-5h2.2v5H23Z"></path>
                            </g>
                            <defs>
                                <clipPath id="icon_work_light_svg__a">
                                    <path fill="#fff" transform="translate(10 10)" d="M0 0h28.2v28.2H0z"></path>
                                </clipPath>
                            </defs>
                        </svg>
						경력 및 인증
					...
					<div class="new-career_infoarea"></div>
					<div class="new-career_details">
						<ul>
							<li>
