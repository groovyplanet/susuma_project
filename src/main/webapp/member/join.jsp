		...
		<div class="container main-only">
			<div class="main-area join">
				...
				<div class="menu-tab">
					...
					<label for="radio-user" id="btn-join-user" class="tab-btn active">의뢰인으로 가입<i class="bi bi-check-lg"></i></label> <label for="radio-master" id="btn-join-master" class="tab-btn">수리기사로 가입<i class="bi bi-check-lg"></i></label>
				</div>
				<!-- 입력 폼 -->
				<div class="join-form">
					<form action="joinForm.member" method="post" id="form-join">
						...
						<div id="master-info-area" style="display: none;">
							<div class="input-area">
								...
								<input type="text" class="input-field" placeholder="사업자등록번호를 입력해주세요." autocomplete="no" name="business_num" id="business_num" maxlength="12">
								<p class="caption-error">올바른 형식이 아닙니다.</p>
							</div>
							<!-- 수리 분야(동적 추가 및 삭제) -->
							<div class="input-area">
						...
						<div class="input-area">
							...
							<div class="checkbox-area">
								...
								<span onclick="$('#terms-modal').addClass('show');">이용약관</span> <label for="checkbox-terms">동의 </label>
							</div>
							<div class="checkbox-area">
								<input type="checkbox" name="checkbox-terms" id="checkbox-privacy" value="" class="checkbox-agree" required>
								<span onclick="$('#privacy-modal').addClass('show');">개인정보처리방침</span> <label for="checkbox-privacy">동의 </label>
							</div>
						</div>
					...
					<div id="terms-modal" class="modal terms">
						<div class="container">
							...
							<div class="terms-content">
								...
								<h6>제2조 (정의)</h6>
								<p>
									1. '웹사이트'란 회사가 서비스를 이용자에게 제공하기 위하여 설정한 온라인 플랫폼을 말합니다.<br> 2. '이용자'란 웹사이트에 접속하여 이 약관에 따라 회사가 제공하는 서비스를 받는 회원 및 비회원을 말합니다.<br> 3. '회원'이란 웹사이트에 개인정보를 제공하여 회원등록을 한 자로서, 회사의 정보를 지속적으로 제공받으며 서비스를 계속적으로 이용할 수 있는 자를 말합니다.<br> 4. '비회원'이란 회원에 가입하지 않고 회사가 제공하는 서비스를 이용하는 자를 말합니다.
								</p>

								<h6>제3조 (약관의 명시와 개정)</h6>
								<p>
									1. 회사는 이 약관의 내용을 웹사이트의 초기 서비스화면에 게시합니다.<br> 2. 회사는 약관을 개정할 경우, 적용일자 및 개정사유를 명시하여 적용일자 7일 이전부터 적용일자 전일까지 공지합니다.
								</p>

								<h6>제4조 (서비스의 제공 및 변경)</h6>
								<p>
									1. 회사는 다음과 같은 업무를 수행합니다:<br> - 정보 제공<br> - 콘텐츠 제공<br> - 기타 회사가 정하는 업무<br> 2. 회사는 필요에 따라 서비스의 내용을 변경할 수 있으며, 이 경우 변경된 서비스의 내용 및 제공일자를 명시하여 이용자에게 통지합니다.
								</p>
					...
					<div id="privacy-modal" class="modal terms">
						<div class="container">
							...
							<div class="terms-content">
								...
								<p>
									회사는 이용자의 개인정보를 원칙적으로 외부에 제공하지 않습니다. 다만, 아래의 경우에는 예외로 합니다:<br> - 이용자가 사전에 동의한 경우<br> - 법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우.
								</p>

								<h6>제5조 (개인정보의 안전성 확보 조치)</h6>
								<p>
									회사는 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다:<br> - 관리적 조치: 내부관리계획 수립 및 시행<br> - 기술적 조치: 개인정보처리시스템 등의 접근권한 관리.
								</p>

								<h6>제6조 (개인정보 보호책임자)</h6>
								<p>
									회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 이용자의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다:<br> - 개인정보 보호책임자: [홍길동]<br> - 연락처: [이메일 주소].
								</p>
